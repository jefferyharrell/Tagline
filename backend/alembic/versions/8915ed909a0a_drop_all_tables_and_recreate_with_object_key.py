...
def upgrade() -> None:
    ...
    # Create indexes
    op.create_index(
        op.f("ix_media_objects_ingestion_status"),
        "media_objects",
        ["ingestion_status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_media_objects_created_at"),
        "media_objects",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_media_objects_updated_at"),
        "media_objects",
        ["updated_at"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["media_object_key"], ["media_objects.object_key"], ondelete="CASCADE"
        ),
    ...
    # Create indexes
    op.create_index(
        op.f("ix_media_binaries_media_object_key"),
        "media_binaries",
        ["media_object_key"],
        unique=False,
    )
    op.create_index(
        op.f("ix_media_binaries_s3_key"), "media_binaries", ["s3_key"], unique=False
    )
    ...
    op.create_index(
        "idx_media_objects_search_vector",
        "media_objects",
        ["search_vector"],
        unique=False,
...
def downgrade() -> None:
    ...
    op.execute(
        "DROP TRIGGER IF EXISTS update_media_objects_search_vector_trigger ON media_objects"
    )
