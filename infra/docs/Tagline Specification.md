...
- `object_metadata`: Flexible metadata associated with the media object. See [[Media Object Metadata Structure]] for the structure, standard fields, and conventions.
...
**All details of API endpoints, request/response schemas, authentication, and validation rules are specified in [[Tagline Backend API Reference]].**
