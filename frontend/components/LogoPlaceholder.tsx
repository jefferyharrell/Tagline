  ...
  return (
    ...
    >
      <div className="text-center p-4">
        <div className="text-2xl font-bold text-gray-500 dark:text-gray-400">JLLA</div>
        <div className="text-sm text-gray-400 dark:text-gray-500 mt-2">Logo Placeholder</div>
      </div>
    </div>
  );
}
